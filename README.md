...
* **Procurement** (Penyusun kontrak & termin)
...
* **`/laporan`**: Berkas dokumen PDF laporan Tugas 1-5 versi ter-optimasi (bebas ISO, dilengkapi RACI, Story Points, operational risk register, audit keamanan eksternal, dan Laporan Penyelesaian Soal Esay).
...
* **Skema SQL Supabase**: [Lihat database/supabase_schema.sql](database/supabase_schema.sql)
